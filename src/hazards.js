...
export function updateHazards(hazards, bullets, playerX, playerY, dt, wave) {
...
function spawnAsteroid(hazards) {
...
function spawnBlackHole(hazards) {
...
export function checkHazardCollision(hazards, playerX, playerY, playerW, playerH) {
  // Asteroid collision
...
export function renderHazards(ctx, hazards, time) {
  // Asteroids
  for (const a of hazards.asteroids) {
    ctx.save();
