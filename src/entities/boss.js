import { CANVAS_WIDTH, CANVAS_HEIGHT, ENEMY_BULLET_SPEED, BULLET_SPEED } from '../constants.js';
import { sfxPlayerHit } from '../audio.js';
...
export function updateBoss(boss, bullets, dt) {
...
export function isBossFighting(boss) {
  return boss && boss.active && boss.phase === 'fight';
}

export function renderBoss(ctx, boss, time) {
  if (!boss || !boss.active) return;
