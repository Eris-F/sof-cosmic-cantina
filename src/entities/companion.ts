...
export function createCompanions(): CompanionState {
  return {
    cats: [],
    nextId: 0,
  };
...
export function addCompanion(companions: CompanionState): void {
...
export function renderCompanions(ctx: CanvasRenderingContext2D, companions: CompanionState): void {
  for (const c of companions.cats) {
    ctx.save();
...
export function clearCompanions(companions: CompanionState): void {
