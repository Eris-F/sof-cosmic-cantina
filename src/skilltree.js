...
export function upgradeSkill(branchId, wallet) {
  ...
  const newWallet = { ...wallet, coins: wallet.coins - next.cost };
...
export function renderSkillTree(ctx, skillState, wallet, time) {
