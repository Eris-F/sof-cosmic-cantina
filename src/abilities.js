...
export function updateAbilities(abilities, dt) {
...
export function checkTequilaTrigger(abilities, comboCount, playerX, playerY) {
...
export function checkNearMiss(abilities, playerX, playerY, bullets) {
...
export function isEnemyFrozen(abilities) {
  return abilities.freezeTimer > 0;
}

export function getSplashRadius() {
  return TEQUILA_SPLASH_RADIUS;
}

// Render visual effects — no buttons, just feedback
export function renderAbilityEffects(ctx, abilities, time) {
