...
export function drawCatShip(ctx: CanvasRenderingContext2D, x: number, y: number, skin?: CatSkin): void {
...
export function drawCatLife(ctx: CanvasRenderingContext2D, x: number, y: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
  // Tiny cat face
...
export function drawBreadBullet(ctx: CanvasRenderingContext2D, x: number, y: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
  // Small bread roll
  ctx.fillStyle = '#e4b86e';
...
export function drawSmiski(ctx: CanvasRenderingContext2D, x: number, y: number, frame: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
...
export function drawJellycat(ctx: CanvasRenderingContext2D, x: number, y: number, frame: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
...
export function drawTieFighter(ctx: CanvasRenderingContext2D, x: number, y: number, frame: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
...
export function drawTequilaUFO(ctx: CanvasRenderingContext2D, x: number, y: number, time: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
...
export function drawEnemyBullet(ctx: CanvasRenderingContext2D, x: number, y: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
...
export function drawTulipBlock(ctx: CanvasRenderingContext2D, x: number, y: number, hp: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
...
export function drawLilyBlock(ctx: CanvasRenderingContext2D, x: number, y: number, hp: number): void {
  ctx.save();
  ctx.translate(Math.floor(x), Math.floor(y));
...
export function drawPetal(ctx: CanvasRenderingContext2D, x: number, y: number, size: number, color: string, rotation: number, alpha: number): void {
  ctx.save();
